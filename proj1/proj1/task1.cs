...
namespace com.calitha.goldparser
{
    ...
    enum SymbolConstants : int
    {
        ...
        SYMBOL_ARGUMENT                 = 34, // <argument>
        SYMBOL_ARGUMENTS                = 35, // <arguments>
        SYMBOL_ASSIGNMENT               = 36, // <assignment>
        SYMBOL_CONDITION                = 37, // <condition>
        SYMBOL_DATATYPE                 = 38, // <datatype>
        SYMBOL_DECL                     = 39, // <decl>
        SYMBOL_EXPRESSION               = 40, // <expression>
        SYMBOL_FACTOR_EXPRESSION        = 41, // <factor_expression>
        SYMBOL_FOR_STATEMENT            = 42, // <for_statement>
        SYMBOL_FUNCTION_CALL            = 43, // <function_call>
        SYMBOL_FUNCTION_DEFINITION      = 44, // <function_definition>
        SYMBOL_IDENTIFIER               = 45, // <identifier>
        SYMBOL_IF_STATEMENT             = 46, // <if_statement>
        SYMBOL_INCREMENT_DECREMENT      = 47, // <increment_decrement>
        SYMBOL_NUMERIC_DIGIT            = 48, // <numeric_digit>
        SYMBOL_OPERATOR                 = 49, // <operator>
        SYMBOL_PARAMETER                = 50, // <parameter>
        SYMBOL_PARAMETERS               = 51, // <parameters>
        SYMBOL_PARENTHESIZED_EXPRESSION = 52, // <parenthesized_expression>
        SYMBOL_START_SYMBOL             = 53, // <start_symbol>
        SYMBOL_STATEMENT                = 54, // <statement>
        SYMBOL_STATEMENT_LIST           = 55, // <statement_list>
        SYMBOL_TERM_EXPRESSION          = 56  // <term_expression>
    };

    enum RuleConstants : int
    {
        RULE_START_SYMBOL_START_END                                                                             =  0, // <start_symbol> ::= Start <statement_list> End
        RULE_STATEMENT_LIST                                                                                     =  1, // <statement_list> ::= <statement>
        RULE_STATEMENT_LIST2                                                                                    =  2, // <statement_list> ::= <statement> <statement_list>
        RULE_STATEMENT                                                                                          =  3, // <statement> ::= <if_statement>
        RULE_STATEMENT2                                                                                         =  4, // <statement> ::= <for_statement>
        RULE_STATEMENT3                                                                                         =  5, // <statement> ::= <function_definition>
        RULE_STATEMENT4                                                                                         =  6, // <statement> ::= <function_call>
        RULE_STATEMENT5                                                                                         =  7, // <statement> ::= <assignment>
        ...
        RULE_FACTOR_EXPRESSION_TIMES                                                                            = 19, // <factor_expression> ::= <parenthesized_expression> '*' <factor_expression>
        ...
        RULE_FUNCTION_DEFINITION_FUNCTION_LPAREN_RPAREN_LBRACE_RBRACE                                           = 44, // <function_definition> ::= Function <identifier> '(' ')' '{' <statement_list> '}'
        RULE_FUNCTION_DEFINITION_FUNCTION_LPAREN_RPAREN_LBRACE_RBRACE2                                          = 45, // <function_definition> ::= Function <identifier> '(' <parameters> ')' '{' <statement_list> '}'
        RULE_PARAMETERS_COMMA                                                                                   = 46, // <parameters> ::= <parameter> ',' <parameters>
        RULE_PARAMETERS                                                                                         = 47, // <parameters> ::= <parameter>
        RULE_PARAMETER                                                                                          = 48, // <parameter> ::= <datatype> <identifier>
        RULE_FUNCTION_CALL_CALL_LPAREN_RPAREN_SEMI                                                              = 49, // <function_call> ::= Call <identifier> '(' <arguments> ')' ';'
        RULE_ARGUMENTS_COMMA                                                                                    = 50, // <arguments> ::= <argument> ',' <arguments>
        RULE_ARGUMENTS                                                                                          = 51, // <arguments> ::= <argument>
        RULE_ARGUMENT                                                                                           = 52  // <argument> ::= <expression>
    };
    ...
    public class MyParser
    {
        ...
        public Object CreateObjectFromNonterminal(NonterminalToken token)
        {
            ...
            {
                case (int)RuleConstants.RULE_START_SYMBOL_START_END :
                //<start_symbol> ::= Start <statement_list> End
                ...
                case (int)RuleConstants.RULE_FACTOR_EXPRESSION_TIMES :
                ...
                //<function_definition> ::= Function <identifier> '(' ')' '{' <statement_list> '}'
                //todo: Create a new object using the stored tokens.
                return null;

                case (int)RuleConstants.RULE_FUNCTION_DEFINITION_FUNCTION_LPAREN_RPAREN_LBRACE_RBRACE2 :
